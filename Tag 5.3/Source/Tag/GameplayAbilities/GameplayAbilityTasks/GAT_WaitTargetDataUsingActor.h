...
#include "GAT_WaitTargetDataUsingActor.generated.h"
 ...
 */
UCLASS()
class TAG_API UGAT_WaitTargetDataUsingActor : public UAbilityTask
{
	...
	*/
	...
	static UGAT_WaitTargetDataUsingActor* WaitTargetDataWithReusableActor(
